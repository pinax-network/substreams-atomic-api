...
JOIN Assets AS a ON a.asset_id = s.asset_ids AND a.collection_name = s.collection_name WHERE (collection_name == '${collection_name}') ORDER BY sale_id DESC LIMIT 1`);
